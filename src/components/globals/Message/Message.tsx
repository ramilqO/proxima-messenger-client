...
export default function Message({ message }: { message: IMessageUI }) {
    return (
        <div className={styles.message + " " + (message.isSender() ? styles.message_sender : '')}>
            <div className={styles.message__wrapper}>
                ...
                <div className={styles.message__content + " " + (message.isSender() ? styles.message_sender__content : '')}>
